...
const AdminDashboard = () => {
    ...
    return (
        ...
        <div className="flex flex-wrap justify-evenly gap-3 h-full">
          ...
          <div className=" min-h-[400px] max-w-[400px] shadow rounded flex justify-center items-center w-full  flex-col gap-4 py-4 h-full">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-3">
              <button  onClick={() => navigate('/admin/editProfile')}  className="btn bg-slate-500 text-white font-semibold">
                Edit Profile
              </button>
              <button   onClick={() => navigate('/')} className="btn bg-red-700 text-white font-semibold">
                Home Page
              </button>
            </div>
        ...
        <div className="my-5 justify-center items-center  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4  w-full ">
          <div className=" bg-yellow-300  min-w-[200px] flex flex-col justify-end items-startmin-h-[200px] rounded  ">
            <div className=" flex flex-col justify-start items-start gap-4 p-4 mx-auto">
              <RiCalendarScheduleFill className="w-14 h-14 text-white" />
              <div className="text-white text-left flex gap-4 lg:text-xl font-semibold">
          ...
          <div className=" bg-green-400   min-w-[200px] flex flex-col justify-end items-startmin-h-[200px] rounded  ">
            <div className=" flex flex-col justify-start items-start gap-4 p-4 mx-auto">
          ...
          <div className=" bg-purple-600   min-w-[200px] flex flex-col justify-end items-startmin-h-[200px] rounded  ">
            <div className=" flex flex-col justify-start items-start gap-4 p-4 mx-auto " >
          ...
          <div className=" bg-red-600   min-w-[200px] flex flex-col justify-end items-startmin-h-[200px] rounded  ">
            <div className=" flex flex-col justify-start items-start gap-4 p-4 mx-auto">
              <RiCalendarScheduleFill className="w-14 h-14 text-white" />
              <div className="text-white text-left flex gap-4 lg:text-lg font-semibold">
